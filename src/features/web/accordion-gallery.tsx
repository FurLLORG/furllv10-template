    ...
    (animate: boolean) => {
      ...
      panels.forEach((panel, i) => {
        ...
        if (showLabels && bar && text) {
          const caption = desc ? [bar, text, desc] : [bar, text]
          if (isActive) {
            tl.to(
              caption,
              {
          ...
          >
            ...
            {showLabels && (
              <span className='ag-panel__label' aria-hidden='true'>
                <span className='ag-panel__label-head'>
                  <span
                ...
                {item.description && item.description.length > 0 && (
                  ...
                  >
                    {item.description.map((d) => (
                      <span key={d} className='ag-panel__desc-item'>
                        {d}
                      </span>
                    ))}
                  </span>
            ...
            {!isActive && item.label && (
              <span className='ag-panel__vlabel' aria-hidden='true'>
                {item.label}
              </span>
            )}
          </Tag>
