...
> **维护状态**：本模板已进入维护冻结阶段，后续将不再由官方持续迭代更新。现有版本仍可正常使用，欢迎用户根据自身业务需求自行 fork 本仓库进行修改和维护；如果你有通用的改进或修复，也欢迎提交 Issue 或 Pull Request。
...
> **维护状态**：本模板当前版本作为维护冻结版本发布，官方暂不承诺后续持续开发和功能更新。你可以直接 fork 本仓库，在自己的分支中继续维护和定制；通用的功能改进与问题修复仍欢迎通过 Pull Request 贡献。
>
